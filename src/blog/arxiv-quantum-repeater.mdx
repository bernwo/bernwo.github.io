...
As mentioned in <a href="/posts/why-is-1-erasure-error-not-the-same-as-a-single-qubit-error">Why is a quantum erasure error and a Pauli error not the same?</a> blog post, I had something big that had been in the works for quite some time with great collaborators, and it is now finally out on <a href="https://arxiv.org/abs/2306.07224">arxiv</a>[@Wo2023] I'm especially excited about this because this work combines two different quantum error correcting code to form a robust hybrid quantum repeater network architecture that bridges intercontinental distances for quantum communication.
